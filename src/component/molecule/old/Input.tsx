import React, {
  ...
  const FloatingLabelInput: React.ForwardRefRenderFunction<InputRef, Props> = (
    ...
    containerStyles =
      containerStyles !== undefined
        ...
        : {
            ...
            borderColor: error ? colors.red100 : isFocusedState ? colors.momoBlue : '#000',
          };
    ...
    console.log('bgColorAnimation', bgColorAnimation);
    const colorAnimation = useAnimatedStyle(() => {
      ...
      return {
        // color: isFocusedState ? colors.momoBlue : '#000',
        color: error ?  colors.red100  : isFocusedState ? colors.momoBlue : '#000',
        // color,
      };
    });
    // bgColorAnimation
